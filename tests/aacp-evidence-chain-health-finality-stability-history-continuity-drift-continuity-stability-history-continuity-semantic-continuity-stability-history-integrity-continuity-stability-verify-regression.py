...
SOURCE = ROOT / (
    ...
    "stability-history-integrity-continuity-stability-verify.py"
)
...
PHASE67_OUTPUT = BASE / (
    ...
    "semantic-continuity-stability-history-integrity-continuity-stability-verify.json"
)

PHASE67_CHECKPOINT = BASE / (
    "aacp-evidence-chain-health-finality-stability-history-"
    "continuity-drift-continuity-stability-history-continuity-"
    "semantic-continuity-stability-history-integrity-continuity-stability-verify-checkpoint.json"
)
...
print("PHASE67 REGRESSION: 10/10 PASS")
