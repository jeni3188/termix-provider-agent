...
SOURCE = ROOT / (
    ...
    "stability-history-integrity-continuity-stability-history-determinism-integrity-continuity-stability-verify.py"
)
...
PHASE72_OUTPUT = BASE / (
    ...
    "semantic-continuity-stability-history-integrity-continuity-stability-history-determinism-integrity-continuity-stability-verify.json"
)

PHASE72_CHECKPOINT = BASE / (
    "aacp-evidence-chain-health-finality-stability-history-"
    "continuity-drift-continuity-stability-history-continuity-"
    "semantic-continuity-stability-history-integrity-continuity-stability-history-determinism-integrity-continuity-stability-verify-checkpoint.json"
)
...
print("PHASE72 REGRESSION: 10/10 PASS")
