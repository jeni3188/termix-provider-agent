...
SOURCE = ROOT / (
    ...
    "stability-history-integrity-continuity-stability-history-determinism-integrity-continuity-verify.py"
)
...
PHASE71_OUTPUT = BASE / (
    ...
    "semantic-continuity-stability-history-integrity-continuity-stability-history-determinism-integrity-continuity-verify.json"
)

PHASE71_CHECKPOINT = BASE / (
    "aacp-evidence-chain-health-finality-stability-history-"
    "continuity-drift-continuity-stability-history-continuity-"
    "semantic-continuity-stability-history-integrity-continuity-stability-history-determinism-integrity-continuity-verify-checkpoint.json"
)
...
print("PHASE71 REGRESSION: 10/10 PASS")
