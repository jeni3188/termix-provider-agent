...
SOURCE = ROOT / (
    ...
    "stability-history-integrity-continuity-verify.py"
)
...
PHASE66_OUTPUT = BASE / (
    ...
    "semantic-continuity-stability-history-integrity-continuity-verify.json"
)

PHASE66_CHECKPOINT = BASE / (
    "aacp-evidence-chain-health-finality-stability-history-"
    "continuity-drift-continuity-stability-history-continuity-"
    "semantic-continuity-stability-history-integrity-continuity-verify-checkpoint.json"
)
...
print("PHASE66 REGRESSION: 10/10 PASS")
