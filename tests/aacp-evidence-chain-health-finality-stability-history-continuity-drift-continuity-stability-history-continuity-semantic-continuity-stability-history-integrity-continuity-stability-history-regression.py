...
SOURCE = ROOT / (
    ...
    "stability-history-integrity-continuity-stability-history-verify.py"
)
...
PHASE68_OUTPUT = BASE / (
    ...
    "semantic-continuity-stability-history-integrity-continuity-stability-history-verify.json"
)

PHASE68_CHECKPOINT = BASE / (
    "aacp-evidence-chain-health-finality-stability-history-"
    "continuity-drift-continuity-stability-history-continuity-"
    "semantic-continuity-stability-history-integrity-continuity-stability-history-verify-checkpoint.json"
)
...
print("PHASE68 REGRESSION: 10/10 PASS")
