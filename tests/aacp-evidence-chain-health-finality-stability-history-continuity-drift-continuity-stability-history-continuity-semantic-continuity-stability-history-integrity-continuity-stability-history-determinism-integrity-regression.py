...
SOURCE = ROOT / (
    ...
    "stability-history-integrity-continuity-stability-history-determinism-integrity-verify.py"
)
...
PHASE70_OUTPUT = BASE / (
    ...
    "semantic-continuity-stability-history-integrity-continuity-stability-history-determinism-integrity-verify.json"
)

PHASE70_CHECKPOINT = BASE / (
    "aacp-evidence-chain-health-finality-stability-history-"
    "continuity-drift-continuity-stability-history-continuity-"
    "semantic-continuity-stability-history-integrity-continuity-stability-history-determinism-integrity-verify-checkpoint.json"
)
...
print("PHASE70 REGRESSION: 10/10 PASS")
